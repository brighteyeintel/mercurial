        ...
        <div className="flex min-h-screen flex-col text-white">
            ...
            <main className="flex-1 container mx-auto px-4 py-8 backdrop-blur-[2px]">
                ...
                <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-3">
                    {/* My Routes */}
                    <a href="/my-routes" className="group relative hover:cursor-pointer overflow-hidden rounded-lg border border-zinc-800 bg-zinc-900/50 p-8 hover:border-zinc-700 hover:bg-zinc-900 transition-all">
